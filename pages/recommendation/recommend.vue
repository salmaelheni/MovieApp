  ...
  <NavbarComponent/>
    ...
    <div v-else class="container movies">
      ...
      <div v-if="movies.length ===0" id="movie-grid" class="movies-grid">
        <h1>No recommendation available for the moment</h1>
      </div>
...
export default {
    ...
    methods: {
        async getMovies() {
            const result = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=c3973a7fdda35b0058bef3411c380b1d`);
